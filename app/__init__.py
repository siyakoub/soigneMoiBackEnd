...
from app.routes import user_route, administrator_route, medecin_route, session_route, avis_route, prescription_route, entreessorties_route, sejour_route
...
app.register_blueprint(prescription_route.prescription_bp, url_prefix='/api/prescription')
app.register_blueprint(sejour_route.sejour_bp, url_prefix="/api/sejour")
app.register_blueprint(entreessorties_route.es_bp, url_prefix="/api/entreesortie")
